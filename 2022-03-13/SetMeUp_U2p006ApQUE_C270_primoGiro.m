%% user input
path(iScanSetUps)="2022\Emittanze 2022\primo giro\Scan U2-06-H26";
...
scanDescription(iScanSetUps)="2022-03-13 - U2-006A-QUE - C, 270 mm - primo Giro";
plotName(iScanSetUps)="U2-006A-QUE_C270_primoGiro";
...
fitIndicesV=fitIndicesH+2; % VER plane, symmetric, 7 couples (min at ID=20)
...
fitIndices(2,:,2,:,iScanSetUps)=fitIndices(1,:,1,:,iScanSetUps)-iCurr2mon(1)+iCurr2mon(2); % HOR plane same as CAM (apart from shift of IDs)
% - post processing
