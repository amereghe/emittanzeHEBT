...
path(iScanSetUps)="2021\QuadScanSep2021\ScanZ218-C270"; % subfolder in parentPath
currFile(iScanSetUps)="2021\QuadScanSep2021\ScanZ218-RFKOC270mmSala1.xls";
LGENscanned(iScanSetUps)="PB-009A-LGEN";              % scanning quad
LGENscannedNickName(iScanSetUps)="Z2-018A-QUE";
scanDescription(iScanSetUps)="scan: Z2-018A-QUE - C, 270 mm";
plotName(iScanSetUps)="Z2-018A-QUE_C270";
...
fitIndicesH=[11 49; 14 46; 17 43; 20 40; 23 37; 25 34; 27 32]'; % symmetric, 7 couples (min at ID=29-30)
fitIndicesV=fitIndicesH-1; % symmetric, 7 couples (min at ID=28-29)
...
fitIndices(2,:,1,1:nFitRanges(1,iScanSetUps),iScanSetUps)=fitIndices(1,:,1,1:nFitRanges(1,iScanSetUps),iScanSetUps)+1;
fitIndices(2,:,2,1:nFitRanges(2,iScanSetUps),iScanSetUps)=fitIndices(1,:,2,1:nFitRanges(2,iScanSetUps),iScanSetUps)+2;
% - post processing
