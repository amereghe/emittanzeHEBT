function ShowFittedOpticsFunctionsGrouped(beta,alpha,emiG,disp,dispP,zz,zp,xVals,xLab,planeLabs,labels1,labels2,myTit)
    ...
    for iPlane=1:length(planeLabs)
        for iLab2=1:length(labels2)
            ...
            for iFitSet=1:nFitSets
                ...
                plot(xVals,beta(iLab2,:,iPlane,iFitSet),".-","Color",cm(iFitSet,:));
            end
            ...
            for iFitSet=1:nFitSets
                if ( iFitSet>1 ), hold on; end
                plot(xVals,alpha(iLab2,:,iPlane,iFitSet),".-","Color",cm(iFitSet,:));
            end
            ...
            for iFitSet=1:nFitSets
                if ( iFitSet>1 ), hold on; end
                plot(xVals,emiG(iLab2,:,iPlane,iFitSet)*1E6,".-","Color",cm(iFitSet,:));
            end
            ...
            for iFitSet=1:nFitSets
                if ( iFitSet>1 ), hold on; end
                plot(xVals,disp(iLab2,:,iPlane,iFitSet),".-","Color",cm(iFitSet,:));
            end
            ...
            for iFitSet=1:nFitSets
                if ( iFitSet>1 ), hold on; end
                plot(xVals,dispP(iLab2,:,iPlane,iFitSet),".-","Color",cm(iFitSet,:));
            end
            ...
            for iFitSet=1:nFitSets
                if ( iFitSet>1 ), hold on; end
                plot(xVals,zz(iLab2,:,iPlane,iFitSet)*1E3,".-","Color",cm(iFitSet,:));
            end
            ...
            for iFitSet=1:nFitSets
                if ( iFitSet>1 ), hold on; end
                plot(xVals,zp(iLab2,:,iPlane,iFitSet)*1E3,".-","Color",cm(iFitSet,:));
            end
